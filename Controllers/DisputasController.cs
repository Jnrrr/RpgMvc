...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://niltonsales.somee.com/RpgApi/Disputas/";
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://niltonsales.somee.com/RpgApi/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://niltonsales.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                List<PersonagemViewModel> listaPersonagens = await Task.Run(() =>
                    JsonConvert.DeserializeObject<List<PersonagemViewModel>>(serialized));
                string uriDisputa = "http://niltonsales.somee.com/RpgApi/Disputas/DisputaEmGrupo";
